...
const components = {
  BooksCardBook: () => import('../../components/books/CardBook.vue' /* webpackChunkName: "components/books-card-book" */).then(c => wrapFunctional(c.default || c)),
  BooksShop: () => import('../../components/books/Shop.vue' /* webpackChunkName: "components/books-shop" */).then(c => wrapFunctional(c.default || c)),
  BooksShopBook: () => import('../../components/books/ShopBook.vue' /* webpackChunkName: "components/books-shop-book" */).then(c => wrapFunctional(c.default || c)),
