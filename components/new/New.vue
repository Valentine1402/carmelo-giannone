<template>
  <section>
    <h1
      class="font-semibold bg-backgroundBlue text-headingBlue md:h-20 py-3 text-xl text-center md:text-4xl md:pt-7"
    >
      Nuova pubblicazione
    </h1>
